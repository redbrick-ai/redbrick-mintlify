...
<Frame caption="Basic viewing interactions.">
    <iframe className="w-full aspect-video" src="https://share.redbrickai.com/QMZlvrSJ" />
</Frame>
...
<Frame caption="Basic windowing functions.">
    <iframe className="w-full aspect-video" src="https://share.redbrickai.com/ytY3Qyg6" />
</Frame>
...
<Frame caption="Using crosshairs and oblique planes.">
    <iframe className="w-full aspect-video" src="https://share.redbrickai.com/jjCnK3MT" />
</Frame>
...
<Frame caption="Displaying MIP.">
    <iframe className="w-full aspect-video" src="https://share.redbrickai.com/M8bQSW5f" />
</Frame>
...
<Frame caption="Creating multiple layout tabs.">
    <iframe className="w-full aspect-video" src="https://share.redbrickai.com/Hy6gjRL8" />
</Frame>
...
<Frame caption="The Study Selector displaying 3 DICOM studies and their corresponding scans.">
    <iframe className="w-full aspect-video" src="https://share.redbrickai.com/vv0tJZNB" />
</Frame>
...
<Frame caption="The Command Bar.">
    <iframe className="w-full aspect-video" src="https://share.redbrickai.com/Y6w9Fbyt" />
</Frame>
