...
<Frame caption="Intellisync with orthogonal imaging axis">
  <iframe className="w-full aspect-video" src="https://www.loom.com/embed/31ee8cf4d40946059365ee9686d95514" alt="Intellisync with orthogonal imaging axis" />
</Frame>

<Frame caption="Intellisync with label mirroring and weighted MRIs">
  <iframe className="w-full aspect-video" src="https://www.loom.com/embed/b3fcff5356d244e5b3a952681d435a1b" alt="Intellisync with label mirroring and weighted MRIs" />
</Frame>
