...
2. **Top Bar -** contains Task-level actions such as task submission and saving and the environment settings (Windowing, Layout), [Version Explorer](../creating-editing-and-deleting-annotations#annotation-version-explorer), [Segmentation Tools](../segmentation/#segmentation-and-other-tools), and Quick Measurement Tools.
...
<Frame caption="Basic viewing interactions.">
  <iframe className="w-full aspect-video" src="https://share.redbrickai.com/QMZlvrSJ" alt="Basic viewing interactions." />
</Frame>
...
<Frame caption="Basic windowing functions.">
  <iframe className="w-full aspect-video" src="https://share.redbrickai.com/ytY3Qyg6" alt="Basic windowing functions." />
</Frame>
...
<Frame caption="Using crosshairs and oblique planes.">
  <iframe className="w-full aspect-video" src="https://share.redbrickai.com/jjCnK3MT" alt="Using crosshairs and oblique planes." />
</Frame>
...
<Frame caption="Displaying MIP.">
  <iframe className="w-full aspect-video" src="https://share.redbrickai.com/M8bQSW5f" alt="Displaying MIP." />
</Frame>
...
RedBrick AI's viewer can be customized to display studies and series in a huge range of configurations, either manually or by using [hanging protocols](../../project-pages/settings-page/custom-hanging-protocol) to display single or multiple series.&#x20;
...
<Frame caption="Creating multiple layout tabs">
  <iframe className="w-full aspect-video" src="https://share.redbrickai.com/Hy6gjRL8" alt="Creating multiple layout tabs" />
</Frame>
...
<Frame caption="The Study Selector displaying 3 DICOM studies and their corresponding scans.">
  <iframe className="w-full aspect-video" src="https://share.redbrickai.com/vv0tJZNB" alt="The Study Selector displaying 3 DICOM studies and their corresponding scans." />
</Frame>
...
<Frame caption="Something else here">
  <iframe className="w-full aspect-video" src="https://share.redbrickai.com/Y6w9Fbyt" alt="Something else here" />
</Frame>
