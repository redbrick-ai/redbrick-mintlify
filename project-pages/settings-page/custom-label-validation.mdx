...
<Frame caption="Overview of custom label validation">
  <iframe className="w-full aspect-video" src="https://www.loom.com/share/9ae2535b823247eea128dbd2f24503e5" alt="Overview of custom label validation" />
</Frame>
...
<Frame caption="Custom label validation in settings">
    <img src="/assets/images/project-pages/settings-page/custom-label-validation.png" alt="" />
</Frame>
...
<CardGroup cols={2}>
  <Frame caption="Submission allowed">
      <img src="/assets/images/project-pages/settings-page/submission-allowed.png" alt="" />
  </Frame>
  <Frame caption="Submission with errors prevented">
      <img src="/assets/images/project-pages/settings-page/submission-with-errors-prevented.png" alt="" />
  </Frame>
</CardGroup>
...
<Frame>
  <img src="/assets/images/project-pages/settings-page/validate-code.png" alt="" />
</Frame>
...
<Frame caption="Submission with errors is allowed">
  <img src="/assets/images/project-pages/settings-page/submission-allowed-bottom.png" alt="" />
</Frame>
<Frame caption="Submission with errors is prevented">
  <img src="/assets/images/project-pages/settings-page/submission-prevented-bottom.png" alt="" />
</Frame>
