...
<Frame caption="">
  <iframe className="w-full aspect-video" src="https://www.loom.com/share/a5b5255cd1954bd590849a8e939c9b5f" alt="" />
</Frame>
...
Hanging protocols can be used along side [intellisync](../../annotation-and-viewer/viewer-basics/intellisync "mention")for ease of use when annotating scans in a study.&#x20;
