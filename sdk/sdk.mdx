...
Public storage provider (Sub class of [`StorageProvider`](#redbrick.StorageProvider)).

* **Variables:**
  * **storage_id** (*str*) – `redbrick.StorageMethod.PUBLIC`
  * **name** (*str*) – `"Public"`
  * **details** ([*redbrick.StorageMethod.Public.Details*](#redbrick.StorageMethod.Public.Details)) – Public storage method details.
...
* **Return type:**
  [`Public`](#redbrick.StorageMethod.Public)

#### *class* RedBrick

RedBrick storage provider (Sub class of [`StorageProvider`](#redbrick.StorageProvider)).

* **Variables:**
  * **storage_id** (*str*) – `redbrick.StorageMethod.REDBRICK`
  * **name** (*str*) – `"Direct Upload"`
  * **details** ([*redbrick.StorageMethod.RedBrick.Details*](#redbrick.StorageMethod.RedBrick.Details)) – RedBrick storage method details.
...
* **Return type:**
  [`RedBrick`](#redbrick.StorageMethod.RedBrick)

#### *class* AWSS3(storage_id, name, details)

AWS S3 storage provider (Sub class of [`StorageProvider`](#redbrick.StorageProvider)).

* **Variables:**
  * **storage_id** (*str*) – AWS S3 storage id.
  * **name** (*str*) – AWS S3 storage name.
  * **details** ([*redbrick.StorageMethod.AWSS3.Details*](#redbrick.StorageMethod.AWSS3.Details)) – AWS S3 storage method details.
...
* **Return type:**
  [`Details`](#redbrick.StorageMethod.AWSS3.Details)
...
Google cloud storage provider (Sub class of [`StorageProvider`](#redbrick.StorageProvider)).

* **Variables:**
  * **storage_id** (*str*) – Google cloud storage id.
  * **name** (*str*) – Google cloud storage name.
  * **details** ([*redbrick.StorageMethod.GoogleCloud.Details*](#redbrick.StorageMethod.GoogleCloud.Details)) – Google cloud storage method details.
...
Azure blob storage provider (Sub class of [`StorageProvider`](#redbrick.StorageProvider)).

* **Variables:**
  * **storage_id** (*str*) – Azure blob storage id.
  * **name** (*str*) – Azure blob storage name.
  * **details** ([*redbrick.StorageMethod.AzureBlob.Details*](#redbrick.StorageMethod.AzureBlob.Details)) – Azure blob storage method details.
...
AltaDB storage provider (Sub class of [`StorageProvider`](#redbrick.StorageProvider)).

* **Variables:**
  * **storage_id** (*str*) – AltaDB storage id.
  * **name** (*str*) – AltaDB storage name.
  * **details** ([*redbrick.StorageMethod.AltaDB.Details*](#redbrick.StorageMethod.AltaDB.Details)) – AltaDB storage method details.
...
- redbrick.StorageMethod.Public ([`Public`](#redbrick.StorageMethod.Public))
- redbrick.StorageMethod.RedBrick ([`RedBrick`](#redbrick.StorageMethod.RedBrick))
- redbrick.StorageMethod.AWSS3 ([`AWSS3`](#redbrick.StorageMethod.AWSS3))
- redbrick.StorageMethod.GoogleCloud ([`GoogleCloud`](#redbrick.StorageMethod.GoogleCloud))
- redbrick.StorageMethod.AzureBlob ([`AzureBlob`](#redbrick.StorageMethod.AzureBlob))
- redbrick.StorageMethod.AltaDB ([`AltaDB`](#redbrick.StorageMethod.AltaDB))
...
* **Return type:**
  [`Details`](#redbrick.StorageProvider.Details)
...
* **Parameters:**
  ...
  * **on_submit** (*Union* *[**bool* *,* *str* *]*  *= True*) – The next stage for the task when submitted in current stage.
...
* **Parameters:**
  ...
  * **read_only_labels_edit_access** (*Optional* *[*[*ProjectMember.Role*](#redbrick.ProjectMember.Role) *]*) – Access level to change the read only labels. (Default: None)
...
* **Return type:**
  [`Config`](#redbrick.LabelStage.Config)
...
* **Parameters:**
  * **stage_name** (*str*) – Stage name.
  * **on_accept** (*Union* *[**bool* *,* *str* *]*  *= True*) – The next stage for the task when accepted in current stage.
    If True, the task will go to ground truth.
    If False, the task will be archived.
  * **on_reject** (*Union* *[**bool* *,* *str* *]*  *= False*) – The next stage for the task when rejected in current stage.
    If True, the task will go to ground truth.
    If False, the task will be archived.
  * **config** (*Config = Config* *(* *)*) – Stage config.
...
* **Return type:**
  [`Config`](#redbrick.ReviewStage.Config)
...
* **Parameters:**
  ...
  * **taxonomy_objects** (*Optional* *[**List* *[*[*ModelStage.ModelTaxonomyMap*](#redbrick.ModelStage.ModelTaxonomyMap) *]* *]*) – Mapping of model classes to project’s taxonomy objects.
...
* **Return type:**
  [`Config`](#redbrick.ModelStage.Config)
...
* **Parameters:**
  ...
  * **role** ([*OrgMember.Role*](#redbrick.OrgMember.Role)) – User role in organization.
...
* **Parameters:**
  ...
  * **role** ([*ProjectMember.Role*](#redbrick.ProjectMember.Role)) – User role in project.
  * **stages** (*Optional* *[**List* *[**str* *]* *]*  *= None*) – Stages that the member has access to (Applicable for MEMBER role).
  * **org_membership** (*Optional* *[*[*OrgMember*](#redbrick.OrgMember) *]*  *= None*) – Organization memberhip.
...
* **Parameters:**
  * **org_id** (*str*) – Your organizations unique id [https://app.redbrickai.com](https://app.redbrickai.com)/<org_id>/.
  * **api_key** (*str*) – Your secret api_key, can be created from the RedBrick AI platform.
  * **url** (*str = DEFAULT_URL*) – Should default to [https://api.redbrickai.com](https://api.redbrickai.com)
* **Return type:**
...
* **Parameters:**
  * **org_id** (*str*) – Your organizations unique id [https://app.redbrickai.com](https://app.redbrickai.com)/<org_id>/
  * **project_id** (*str*) – Your projects unique id [https://app.redbrickai.com](https://app.redbrickai.com)/<org_id>/<project_id>/
  * **api_key** (*str*) – Your secret api_key, can be created from the RedBrick AI platform.
  * **url** (*str = DEFAULT_URL*) – Should default to [https://api.redbrickai.com](https://api.redbrickai.com)
* **Return type:**
...
* **Parameters:**
  * **project_id** (*Optional* *[**str* *]*  *= None*) – project id which has to be fetched.
...
The [`redbrick.RBOrganization`](#redbrick.RBOrganization) object allows you to programmatically interact with
...
* **Variables:**
  * **team** ([*redbrick.common.member.Team*](#redbrick.common.member.Team)) – Organization team management.
  * **storage** ([*redbrick.common.storage.Storage*](#redbrick.common.storage.Storage)) – Organization storage methods integration.
...
* **Return type:**
  `Union`[`List`[`str`], `List`[[`Taxonomy`](formats/taxonomy.md#redbrick.types.taxonomy.Taxonomy)]]
...
* **Return type:**
  `List`[[`RBProject`](#redbrick.RBProject)]
...
* **Parameters:**
  ...
  * **exists_okay** (*bool = False*) – Allow workspaces with the same name to be returned instead of trying to create
...
* **Return type:**
  [redbrick.RBWorkspace](#redbrick.RBWorkspace)
...
* **Parameters:**
  ...
  * **taxonomy_name** (*str*) – The name of the taxonomy you want to use for this project.
    Taxonomies can be found on the left side bar of the platform.
  * **stages** (*List* *[*[*Stage*](#redbrick.Stage) *]*) – List of stage configs.
  * **exists_okay** (*bool = False*) – Allow projects with the same name to be returned instead of trying to create
...
* **Return type:**
  [redbrick.RBProject](#redbrick.RBProject)
* **Raises:**
...
* **Parameters:**
  ...
  * **taxonomy_name** (*str*) – The name of the taxonomy you want to use for this project.
    Taxonomies can be found on the left side bar of the platform.
  * **reviews** (*int = 0*) – The number of review stages that you want to add after the label
    stage.
  * **exists_okay** (*bool = False*) – Allow projects with the same name to be returned instead of trying to create
    a new project. Useful for when running the same script repeatedly when you
    do not want to keep creating new projects.
...
* **Parameters:**
  ...
  * **study_classify** (`Optional`[`List`[[`Attribute`](formats/taxonomy.md#redbrick.types.taxonomy.Attribute)]]) – Study level classification applies to the task.
  * **series_classify** (`Optional`[`List`[[`Attribute`](formats/taxonomy.md#redbrick.types.taxonomy.Attribute)]]) – Series level classification applies to a single series within a task.
  * **instance_classify** (`Optional`[`List`[[`Attribute`](formats/taxonomy.md#redbrick.types.taxonomy.Attribute)]]) – Instance classification applies to a single frame (video) or slice (3D volume).
  * **object_types** (`Optional`[`List`[[`ObjectType`](formats/taxonomy.md#redbrick.types.taxonomy.ObjectType)]]) – Object types are used to annotate features/objects in tasks, for example, segmentation or bounding boxes.
* **Raises:**
...
* **Return type:**
  [`Taxonomy`](formats/taxonomy.md#redbrick.types.taxonomy.Taxonomy)
...
* **Return type:**
  List[[OrgMember](#redbrick.OrgMember)]
...
* **Return type:**
  List[[OrgInvite](#redbrick.OrgInvite)]
...
* **Parameters:**
  **invitation** ([*OrgInvite*](#redbrick.OrgInvite)) – Organization invite
* **Return type:**
  [OrgInvite](#redbrick.OrgInvite)
...
* **Return type:**
  `List`[[`StorageProvider`](#redbrick.StorageProvider)]
...
* **Parameters:**
  * **storage_id** (*str*) – Your RedBrick AI external storage_id. This can be found under the Storage Tab
    on the RedBrick AI platform. To directly upload images to rbai,
    use redbrick.StorageMethod.REDBRICK.
  * **points** (List[[`InputTask`](formats/index.md#redbrick.types.task.InputTask)]) – Please see the RedBrick AI reference documentation for overview of the format.
    [https://sdk.redbrickai.com/formats/index.html#import](https://sdk.redbrickai.com/formats/index.html#import).
...
* **Parameters:**
  ...
  * **points** (List[[`InputTask`](formats/index.md#redbrick.types.task.InputTask)]) – List of datapoints with dpId and metaData values.
* **Return type:**
  `None`
...
* **Parameters:**
  ...
  * **concurrency** (*int = 50*) – The number of datapoints to delete at a time.
...
* **Variables:**
  * **upload** ([*redbrick.common.upload.Upload*](#redbrick.common.upload.Upload)) – Upload data to project.
  * **labeling** ([*redbrick.common.labeling.Labeling*](#redbrick.common.labeling.Labeling)) – Labeling activities.
  * **review** ([*redbrick.common.labeling.Labeling*](#redbrick.common.labeling.Labeling)) – Review activities.
  * **export** ([*redbrick.common.export.Export*](#redbrick.common.export.Export)) – Project data export.
  * **settings** ([*redbrick.common.settings.Settings*](#redbrick.common.settings.Settings)) – Project settings management.
  * **workforce** ([*redbrick.common.member.Workforce*](#redbrick.common.member.Workforce)) – Project workforce management.
...
#### *abstract property* taxonomy *: [Taxonomy](formats/taxonomy.md#redbrick.types.taxonomy.Taxonomy)*
...
#### *abstract property* stages *: List[[Stage](#redbrick.Stage)]*
...
* **Parameters:**
  * **storage_id** (*str*) – The unique ID of your RedBrick AI storage method integration.
...
The export module has many functions for exporting annotations and meta-data from projects. The export module is available from the [`redbrick.RBProject`](#redbrick.RBProject) module.
...
* **Parameters:**
  * **concurrency** (*int = 10*) – 
  * **only_ground_truth** (*bool = False*) – If set to True, will only return data that has
    been completed in your workflow. If False, will
    export latest state.
  * **stage_name** (*Optional* *[**str* *]*  *= None*) – If set, will only export tasks that are currently
    in the given stage.
  * **task_id** (*Optional* *[**str* *]*  *= None*) – If the unique task_id is mentioned, only a single
    datapoint will be exported.
  * **from_timestamp** (*Optional* *[**float* *]*  *= None*) – If the timestamp is mentioned, will only export tasks
  ...
  * **without_masks** (*bool = False*) – Exports only tasks JSON without downloading any segmentation masks.
    Note: This is not recommended for tasks with overlapping labels.
  * **without_json** (*bool = False*) – Doesn’t create the tasks JSON file.
  * **semantic_mask** (*bool = False*) – Whether to export all segmentations as semantic_mask.
  ...
  * **binary_mask** (*Optional* *[**bool* *]*  *= None*) – Whether to export all segmentations as binary masks.
  ...
  * **no_consensus** (*Optional* *[**bool* *]*  *= None*) – Whether to export tasks without consensus info.
...
* **Returns:**
  ...
  [https://sdk.redbrickai.com/formats/index.html#export](https://sdk.redbrickai.com/formats/index.html#export)
* **Return type:**
  Iterator[[`OutputTask`](formats/index.md#redbrick.types.task.OutputTask)]
...
* **Parameters:**
  * **search** ([`TaskFilters`](#redbrick.TaskFilters) = TaskFilters.ALL) – Task filter type.
  * **concurrency** (*int = 10*) – The number of requests that will be made in parallel.
  * **limit** (*Optional* *[**int* *]*  *= 50*) – The number of tasks to return.
  ...
  * **task_name** (*Optional* *[**str* *]*  *= None*) – If present, will return data for the given task name.
    This will do a prefix search with the given task name.
  * **exact_match** (*bool = False*) – Applicable when searching for tasks by task_name.
    If True, will do a full match instead of partial match.
  * **completed_at** (*Optional* *[**Tuple* *[**Optional* *[**float* *]* *,* *Optional* *[**float* *]* *]* *]*  *= None*) – If present, will return tasks that were completed in the given time range.
...
* **Parameters:**
  ...
  * **only_ground_truth** (*bool = True*) – If set to True, will return events for tasks
...
* **Parameters:**
  ...
  * **is_ground_truth** (*bool = False*) – If labels are provided in `points`, and this parameters
  ...
  * **label_storage_id** (*Optional* *[**str* *]*  *= None*) – Optional label storage id to reference nifti segmentations.
...
* **Parameters:**
  ...
  * **concurrency** (*int = 50*) – The number of tasks to delete at a time.
    We recommend keeping this <= 50.
* **Returns:**
  True if successful, else False.
* **Return type:**
...
* **Parameters:**
  * **storage_id** (*str*) – Your RedBrick AI external storage_id. This can be found under the Storage Tab
    on the RedBrick AI platform. To directly upload images to rbai,
    use redbrick.StorageMethod.REDBRICK.
  * **points** (List[[`InputTask`](formats/index.md#redbrick.types.task.InputTask)]) – List of objects with taskId and series, where series contains
...
* **Parameters:**
  * **tasks** (*List* *[**Dict* *]*) – List of taskIds and their priorities.
    - [{“taskId”: str, “priority”: float([0, 1]), “user”?: str}]
  * **concurrency** (*int = 50*) – The number of tasks to update at a time.
    We recommend keeping this <= 50.
* **Return type:**
  `None`
...
* **Parameters:**
  * **points** (List[[`OutputTask`](formats/index.md#redbrick.types.task.OutputTask)]) – Please see the RedBrick AI reference documentation for overview of the format.
    [https://sdk.redbrickai.com/formats/index.html#export](https://sdk.redbrickai.com/formats/index.html#export).
    All the fields with annotation information are optional.
  * **rt_struct** (*bool = False*) – Upload segmentations from DICOM RT-Struct files.
  * **mhd** (*bool = False*) – Upload segmentations from MHD files.
...
* **Parameters:**
  ...
  * **stage_name** (*str*) – The stage to which you want to move the tasks.
...
have a list of `task_id`, you can use [`list_tasks`](#redbrick.common.export.Export.list_tasks) to
...
* **Parameters:**
  * **stage_name** (*str*) – The stage to which you want to submit the tasks. This must be the
    same stage as which you called get_tasks on.
  * **tasks** (List[[`OutputTask`](formats/index.md#redbrick.types.task.OutputTask)]) – Tasks with new labels or review result.
  * **finalize** (*bool = True*) – Finalize the task. If you want to save the task without submitting, set this to False.
  * **existing_labels** (*bool = False*) – If True, the tasks will be submitted with their existing labels.
    Applies only to Label stage.
  * **rt_struct** (*bool = False*) – Upload segmentations from DICOM RT-Struct files.
  * **mhd** (*bool = False*) – Upload segmentations from MHD files.
  * **review_result** (*Optional* *[**bool* *]*  *= None*) – Accepts or rejects the task based on the boolean value.
    Applies only to Review stage.
  * **label_storage_id** (*Optional* *[**str* *]*  *= None*) – Optional label storage id to reference external nifti segmentations.
...
* **Return type:**
  List[[`OutputTask`](formats/index.md#redbrick.types.task.OutputTask)]
...
* **Parameters:**
  ...
  * **email** (*Optional* *[**str* *]*  *= None*) – The email of the user you want to assign this task to. Make sure the
    user has adequate permissions to be assigned this task in the project.
  * **emails** (*Optional* *[**List* *[**str* *]* *]*  *= None*) – Used for projects with Consensus activated.
  ...
  * **refresh** (*bool = True*) – Used for projects with Consensus activated.
...
* **Return type:**
  List[[ProjectMember](#redbrick.ProjectMember)]
...
* **Parameters:**
  **members** (*List* *[*[*ProjectMember*](#redbrick.ProjectMember) *]*) – List of members to add.
* **Returns:**
...
* **Parameters:**
  **members** (*List* *[*[*ProjectMember*](#redbrick.ProjectMember) *]*) – List of members to update.
* **Returns:**
