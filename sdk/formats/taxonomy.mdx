...
#### options *: `Optional`[`List`[[`AttributeOption`](#redbrick.types.taxonomy.AttributeOption)]]*
...
#### attributes *: `Optional`[`List`[[`Attribute`](#redbrick.types.taxonomy.Attribute)]]*
...
#### studyClassify *: `List`[[`Attribute`](#redbrick.types.taxonomy.Attribute)]*

#### seriesClassify *: `List`[[`Attribute`](#redbrick.types.taxonomy.Attribute)]*

#### instanceClassify *: `List`[[`Attribute`](#redbrick.types.taxonomy.Attribute)]*

#### objectTypes *: `List`[[`ObjectType`](#redbrick.types.taxonomy.ObjectType)]*
