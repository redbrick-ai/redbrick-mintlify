...
To import annotations with your data, you must first create an items JSON file [following the import annotations guide](../importing-annotations-guide).

{% content-ref url="../importing-annotations-guide" %}
[importing-annotations-guide](../importing-annotations-guide)
{% endcontent-ref %}
