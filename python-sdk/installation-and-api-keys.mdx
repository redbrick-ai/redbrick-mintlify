...
<Frame caption="The Integrations tab">
  <img src="/assets/images/python-sdk/integrations.png" alt="The Integrations tab" />
</Frame>

<Frame caption="The API Keys page">
  <img src="/assets/images/python-sdk/api-keys.png" alt="The API Keys page" />
</Frame>
...
**Please note** that all API keys provide the user with the equivalent of [Org Admin permissions](/organizations/what-is-an-organization#organization-level-roles). Be sure to use your API keys with care!
...
<Frame caption="">
  <img src="/assets/images/python-sdk/settings-page.png" alt="" />
</Frame>
